    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24 py-10">
      ...
      <div class="mb-10 text-center flex flex-col items-center">
        ...
        <p class="text-gray-500 text-sm leading-relaxed max-w-[340px] mx-auto">
          Login untuk kelola tugas harian lebih mudah, efisien, dan mendukung produktivitas kerjamu setiap hari.
        </p>
      </div>

      <form @submit.prevent="handleLogin" class="space-y-5 w-full max-w-md mx-auto">
        <div>
        ...
        <div class="relative">
          ...
          <div class="text-right mt-2">
            <NuxtLink to="/forgot-password" class="text-[11px] font-bold text-blue-500 hover:underline">
              Lupa Password ?
            </NuxtLink>
          </div>
        </div>
      ...
      <p class="text-center text-[13px] text-gray-600 mt-10">
        Belum punya akun? 
        <NuxtLink to="/register" class="text-blue-500 font-bold hover:underline ml-1">Daftar</NuxtLink>
      </p>
    </div>
