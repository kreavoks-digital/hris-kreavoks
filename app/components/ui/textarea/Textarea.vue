  ...
  <div class="w-full">
    <textarea 
      ...
      :class="cn(
          ...
          'flex min-h-[100px] w-full rounded-xl border bg-background px-4 py-2 text-sm ring-offset-background placeholder:text-muted-foreground outline-none resize-none',
          // Transitions
